...
export const CRM_FILTER_CATEGORIES: CRMFilterCategory[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "cashback_liberado_nao_usado", label: "Cashback Liberado (Pronto Pra Usar)", kind: "boolean", description: "Cupom já passou o prazo de carência e ainda não expirou — o cliente já pode usar agora." },
      { id: "cashback_dias_para_expirar", label: "Dias Até o Cashback Expirar", kind: "number", description: "Considera o cupom liberado que vence primeiro. Permite valor mínimo, máximo ou faixa (ex.: até 3 dias para expirar)." },
      { id: "cashback_data_geracao", label: "Data de Geração do Cashback", kind: "date", description: "Quando o cupom de cashback mais recente do cliente foi gerado. Pode filtrar por data, últimos dias, há mais de X dias ou intervalo de dias (ex.: gerado há exatamente 1 dia)." },
